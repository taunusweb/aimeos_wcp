...
?>
<div class="swiper mySwiperStart">
	<ul class="list-items swiper-wrapper"><!--
		...
		<?php foreach( $this->get( 'products', [] ) as $id => $productItem ) : ?>
			...
			--><li class="product swiper-slide <?= $enc->attr( $productItem->getConfigValue( 'css-class' ) ); ?>"
